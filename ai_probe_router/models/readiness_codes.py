...
class ReadinessCode(str, Enum):
    ...
    CONNECTOR_PIN_CONFLICT = "CONNECTOR_PIN_CONFLICT"
    CONNECTOR_RESERVED_PIN_OVERRIDE = "CONNECTOR_RESERVED_PIN_OVERRIDE"
    CONNECTOR_ALLOCATION_NEAR_LIMIT = "CONNECTOR_ALLOCATION_NEAR_LIMIT"
...
_READINESS_CODE_SEVERITY: dict[ReadinessCode, str] = {
    ...
    ReadinessCode.CONNECTOR_PIN_CONFLICT: "error",
    ReadinessCode.CONNECTOR_RESERVED_PIN_OVERRIDE: "error",
    ReadinessCode.CONNECTOR_ALLOCATION_NEAR_LIMIT: "warning",
